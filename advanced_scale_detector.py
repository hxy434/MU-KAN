...
# -*- coding: utf-8 -*-
"""
高级比例尺检测模型 - 基于成熟的预训练模型
使用EfficientNet、Vision Transformer和DenseNet等先进架构
"""
...
class AdvancedScaleLengthLoss(nn.Module):
    ...
    def __init__(self, alpha=0.6, beta=0.3, gamma=0.1):
        ...
        self.alpha = alpha  # 对数损失权重
        self.beta = beta    # 相对误差权重
        self.gamma = gamma  # 平滑L1损失权重
...
class AdvancedScaleTrainer:
    ...
    def create_datasets(self, csv_file, img_dir):
        """创建数据集"""
        print(f"📊 创建 {self.model_type} 数据集...")
